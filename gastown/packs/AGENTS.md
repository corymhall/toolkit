# Agent Instructions For `gastown/packs/`

This file scopes the AI contribution contract for the local Gas City pack
family under `gastown/packs/`.

Use it when changing:
- `gastown/packs/base/`
- `gastown/packs/work/`
- `gastown/packs/personal/`
- `gastown/cities/local/` when the change is about how packs compose
...
- `gastown/packs/base/pack.toml`
- `gastown/packs/work/pack.toml`
- `gastown/packs/personal/pack.toml`
- `gastown/packs/base/prompts/shared/`
- `gastown/packs/work/prompts/`
- `gastown/packs/personal/prompts/`
- `gastown/packs/work/formulas/`
- `gastown/cities/local/city.toml`
...
- Inspect current local pack diffs:
  - `git diff -- gastown/packs gastown/cities/local docs/plans/gascity-packs`
...
includes = ["/Users/chall/gt/toolkit/crew/quick/gastown/packs/work"]
```
...
- `gastown/packs/work/prompts/owner-work.md.tmpl`
- `gastown/packs/personal/prompts/owner-personal.md.tmpl`

Shared owner-session sections live in:

- `gastown/packs/base/prompts/shared/owner-common.md.tmpl`
- `gastown/packs/base/prompts/shared/propulsion.md.tmpl`
- `gastown/packs/base/prompts/shared/capability-ledger.md.tmpl`
- `gastown/packs/base/prompts/shared/architecture.md.tmpl`
...
- `gastown/packs/work/formulas/mol-work-branch-ready.formula.toml`
...
- make sure `gastown/cities/local/` still reflects the real pack structure
